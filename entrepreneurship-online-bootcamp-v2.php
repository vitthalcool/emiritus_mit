...
<head>
	...
	<link rel="stylesheet" type="text/css" href="https://eim.mit.edu/bootcamp-assets/css/style_new.css?v=0.0.3">
	<link rel="stylesheet" type="text/css" href="https://eim.mit.edu/bootcamp-assets/css/responsive_new.css?v=0.0.2">
...
<body>
	<div class="wrapper">
		<div class="container-fluid" id="header">
			<div class="container headerlr">
				<header class="header">
					<div class="row">
						  <div class="col-sm-6 headerlr">
							<a href="https://eim.mit.edu/entrepreneurship-online-bootcamp-v2.php" onclick="trackEvent('click','EOB LP','Reload','Partner Logo')"><img src="https://eim.mit.edu/bootcamp-assets/images/logo.png" alt="MIT's Entrepreneurship Bootcamp" title="MIT's Entrepreneurship Bootcamp" class="img-responsive"></a>
						</div>						
					</div>
				</header>
			</div>	
		...
		<div class="header-topic">
			<div class="container no-padd">
				<h1 class="main-title">
					MIT Entrepreneurship Online Bootcamp: <br class="mobile-show">
					From Idea To Startup In 8 Weeks
				</h1>
			</div>	
		</div>
		
		<div class="container df vedio-section">
				<div class="col-md-7 col-sm-6 col-xs-12 no_pad banner-item">
					<div class="video-wrapper youtubevideo">
						<div class="youtubsection" style="">
							<div id="player2"></div>
						</div>
					</div>
				</div>
			...
			<div id="2" class="col-md-5 col-sm-6 col-xs-12 banner-item section-form">
						<form class="form-horizontal registerform" role="form" id="frm" name="frm" method="POST" action="submit-bootcamp.php" >
								<p class="request">Request program info</p>
								<?php
								...
								?>
								<div id="fields" class="fields-wrapper">
									...
									<!-- <div class="form-field small pd-checkbox">
											<label ></label>
											<div class="col-xs-8 col-sm-9 col-md-8">
		...
		<div class="container info-row vedio-section">
				...
				<div class="bg_grey">
					<div class="content-wrapper container">
						...
						<div class="row icon-row text-center display_desktop">
							<img src="https://eim.mit.edu/bootcamp-assets/images/your-learning-journey-graphic1.png" class="img-responsive" alt="Your Learning Journey" title="Your Learning Journey">
						</div>
					...
					<div class="col-md-4 col-sm-4">
						<fieldset class="featured_faculty">
    						<legend align="center" class="img-circle"><img src="https://eim.mit.edu/bootcamp-assets/images/Eric-von-Hippel.png" alt="Professor Eric von Hippel" title="Professor Eric von Hippel"></legend>
								...
								<h5>T. Wilson (1953) Professor of Management; Professor in Management of Innovation and Engineering Systems</h5>
								<p class="data-featured">	
	...
	<div class="model_box">
      ...
      <div class="modal-dialog modal-lg">
		...
		<!--	<div class="clearfix content_p" style="margin-top:30px;">
            <h5>The following payment options are available for the <i>MIT Entrepreneurship Online Bootcamp (Solo Track) program</i>:</h5>
			
				<ul class="ul_style">Pay in Full</ul>
					<li>Pay the entire course fee of <b>$4,300</b> at once</b>.
					</li>
				</ul>

				<ul class="ul_style">Pay in 2 installments</ul>
					<li>The first installment of <b>$1,650</b> would be <b>due immediately</b>.
					</li>
					<li>The second installment of <b>$2,693</b> will be charged on <b>June 30, 2018</b>.
					</li>
				</ul>

				<ul class="ul_style">Pay in 3 installments</ul>
					<li>The first installment of <b>$1,639</b> would be <b>due immediately</b>.
					</li>
					<li>The second installment of <b>$1,639</b> will be charged on <b>June 30, 2018</b>.
					</li>
					<li>The third installment of <b>$1,152</b> will be charged on <b>July 28, 2018</b>.
					</li>
				</ul>
            </div> -->
...
function resetVideo()
{
	 ...
	 jQuery(".banner-item iframe#player2").css('height','auto');
	 if ($(window).width() > 768) 
	 {
		 jQuery(".banner-item").each(function(){
			if (jQuery(this).height() > maxHeight) { maxHeight = jQuery(this).height(); }
		 });
		 jQuery(".banner-item iframe#player2").height(maxHeight);
