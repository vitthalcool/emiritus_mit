...
$MIT_Email_Consent			=isset($_POST['terms'])?trim($_POST['terms']):'false';
/*
$MIT_Email_Consent = '0';
if($terms)
{
...
?>
<form class="form-horizontal mCustomScrollbar" role="form" id="frm" name="frm" action="https://www2.emeritus.org/l/134351/2018-02-21/3hcbhh" method="post">
