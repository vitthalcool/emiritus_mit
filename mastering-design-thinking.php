...
<head>
		...
		<link rel="stylesheet" type="text/css" href="assets/css/responsive_new.css?v=0.0.3">
		...
		<div class="container-fluid" id="header">
			<div class="container">
				<header class="header">
					<div class="row">
						  <div class="col-sm-6">
							<a href="./mastering-design-thinking.php" onclick="trackEvent('click','MDT LP','Reload','Partner Logo')"><img src="https://eim.mit.edu/assets/images/logo.png" alt="MIT Sloan" title="MIT Sloan" class="img-responsive"></a>
						</div>						
					</div>
				</header>
			</div>	
						...
						<div id="2" class="col-md-5 form-div no_pad form-section">
							<form class="form-horizontal contact-form" role="form" id="frm" name="frm" method="POST" action="submit.php">
								...
								<div id="fields">
											...
											<div class="col-xs-12">
												<div class="form-group">
													...
													<div class="col-xs-8 col-sm-9 col-md-8">
														<script src="https://www.linkedin.com/autofill/js/autofill.js" type="text/javascript" ></script><script type="IN/Form2" data-form="frm" data-field-firstname="first_name" data-field-lastname="last_name" data-field-phone="mobile" data-field-email="email" data-field-country="country"></script>
													</div>
												</div>
											</div>
										</div>
									...
									<!-- <div class="form-group small pd-checkbox">											<label class="control-label col-xs-4 col-sm-3 col-md-4"></label>											<div class="col-xs-8 col-sm-9 col-md-8">												<span class="value"><span><input type="checkbox" name="terms" id="terms" value="I allow MIT Sloan to send me email updates on Executive Education Programs"><label class="inline" for="terms" >I allow MIT Sloan to send me email updates on Executive Education Programs</label>												</span></span>											</div>									</div> -->
								<div class="form-group" id="gdpr-consent" style="display:none;"> 
								 ...
								 <div class="form-group">
									...
									<input type="hidden" name="utm_source" value="<?php echo strip_tags($_GET['utm_source']);?>">
									<input type="hidden" name="utm_medium" value="<?php echo strip_tags($_GET['utm_medium']);?>">
									<input type="hidden" name="utm_term" value="<?php echo strip_tags($_GET['utm_term']);?>">
									<input type="hidden" name="utm_content" value="<?php echo strip_tags($_GET['utm_content']);?>">
									<input type="hidden" name="utm_campaign" value="<?php echo strip_tags($_GET['utm_campaign']);?>">
									<input type="hidden" name="matchtype" value="<?php echo strip_tags($_GET['matchtype']);?>">
									<input type="hidden" name="network" value="<?php echo strip_tags($_GET['network']);?>">
									<input type="hidden" name="creative" value="<?php echo strip_tags($_GET['creative']);?>">
									<input type="hidden" name="keyword" value="<?php echo strip_tags($_GET['keyword']);?>">
									<input type="hidden" name="placement" value="<?php echo strip_tags($_GET['placement']);?>">
									<input type="hidden" name="random" value="<?php echo strip_tags($_GET['random']);?>">
									<input type="hidden" name="copy" value="<?php echo strip_tags($_GET['copy']);?>">
									<input type="hidden" name="adposition" value="<?php echo strip_tags($_GET['adposition']);?>">
									<input type="hidden" name="url" value="<?php echo strip_tags($_SERVER['REQUEST_URI']);?>">
								</div>
							</form>
						</div>
