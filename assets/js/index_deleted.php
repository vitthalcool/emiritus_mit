...
<head>
		...
		<link rel="stylesheet" type="text/css" href="css/style_new.css?v=0.0.3">
		<link rel="stylesheet" type="text/css" href="css/responsive_new.css?v=0.0.3">
	...
	<div class="wrapper">
		<div class="container-fluid" id="header">
			<div class="container">
				<header class="header">
					<div class="row">
						  <div class="col-sm-6">
							<a href="https://emeritus.org/" target="_blank" onclick="trackEvent('click','MDT LP','Reload','Partner Logo')"><img src="https://eim.mit.edu/assets/images/logo.png" alt="MIT Sloan" title="MIT Sloan" class="img-responsive"></a>
						</div>						
					</div>
				</header>
			</div>	
				...
				<div class="container df">
					<div class="col-md-7 no_pad">
						...
						<div id="2" class="col-md-5 form-div no_pad form-section">
							<form class="form-horizontal contact-form" role="form" id="frm" name="frm" method="POST" action="submit.php">
								...
								<div id="fields">
									...
									<div class="form-group">
										<div class="col-sm-12 margin-bottom">
											<input type="submit" onclick="trackEvent('click','MDT LP','FormSubmit','Form_Submit',true)" class="btn btn-default download-btn" value="DOWNLOAD BROCHURE >"/>
										</div>
										<div class="col-sm-12 privacy-section">
											<p><small>Your details will not be shared with third parties.</small></p>
											<p><strong><small><a href="http://emeritus.org/privacy-policy/" target="_blank" style="color:#000000;">Privacy Policy</a></small></strong></p>
										</div>
									</div>
				...
				<div class="bg_grey">
					<div class="content-wrapper container">
						...
						<div class="row icon-row text-center display_desktop">
							<img src="images/your-learning-journey-graphic1.png" class="img-responsive" alt="Your Learning Journey" title="Your Learning Journey">
						</div>
						<div class="text-center clearfix">
							<ul class="no-style">
								<li class="col20">
									<div class="box-section blue">
									<img src="images/icon1.png" alt="Video Lectures" title="Video Lectures">
									</div>
									<p class="data-section">128 Video Lectures</p>
								</li>
								<li class="col20">
									<div class="box-section">
									<img src="images/icon2.png" alt="Live Teaching Sessions" title="Live Teaching Sessions">
									</div>
									<p class="data-section">3 Live Teaching Sessions</p>									
								</li>
								<li class="col20">
									<div class="box-section blue">
									<img src="images/icon3.png" alt="Group Projects" title="Group Projects">
									</div>
									<p class="data-section">3 Group Projects</p>
								</li>
								<li class="col20">
									<div class="box-section blue">
									<img src="images/icon4.png" alt="Assignments" title="Assignments">
									</div>
									<p class="data-section">10 Assignments</p>
								</li>
								<li class="col20">
									<div class="box-section blue">
									<img src="images/icon5.png" alt="Capstone Project" title="Capstone Project">
									</div>
									<p class="data-section">1 Capstone Project</p>
								</li>
								<li class="col20">
									<div class="box-section blue">
									<img src="images/icon6.png" alt="Real World Applications" title="Real World Applications">
									</div>
				...
				<h1 class="heading">Faculty</h1>	
					...
					<div class="col-md-4 col-sm-4">
						<fieldset class="featured_faculty">
    						<legend align="center" class="img-circle"><img src="images/Steven-Eppinger.png" alt="Steve Eppinger" title="Steve Eppinger"></legend>
								...
								<a class="txt-color" data-toggle="modal" data-target="#myModal11" onclick="trackEvent('click','MDT LP','Pop Up','More-Info')">More info</a>
  						</fieldset>
					</div>
					<!-- Modal -->
					     	...
					     	<div class="modal-content">
					        	<div class="modal-header text-center">
					         		<button type="button" class="close" data-dismiss="modal">×</button>
					          		<img src="images/Steven-Eppinger.png" alt="Steve Eppinger" title="Steve Eppinger" class="img-circle">
					...
					<div class="col-md-4 col-sm-4">
						<fieldset class="featured_faculty">
    						<legend align="center" class="img-circle"><img src="images/Matthew-Kressy.png" alt="Matthew Kressy" title="Matthew Kressy"></legend>
								...
								<a class="txt-color" data-toggle="modal" data-target="#myModal12" onclick="trackEvent('click','MDT LP','Pop Up','More-Info')">More info</a>
  						</fieldset>
					</div>
					<div class="modal fade" id="myModal12" role="dialog">
					    <div class="modal-dialog modal-lg">
					     	...
					     	<div class="modal-content">
					        	<div class="modal-header text-center">
					         		<button type="button" class="close" data-dismiss="modal">×</button>
					          		<img src="images/Matthew-Kressy.png" alt="Matthew Kressy" title="Matthew Kressy" class="img-circle">
					          		<!-- <h4 class="modal-title">Modal Header</h4> -->
					        	</div>
					       		<div class="modal-body">
					          		<p class="text-center profile">
					...
					<div class="col-md-4 col-sm-4">
						<fieldset class="featured_faculty">
    						<legend align="center" class="img-circle"><img src="images/David-Robertson.png" alt="David Robertson" title="David Robertson"></legend>
								...
								<a class="txt-color" data-toggle="modal" data-target="#myModal13" onclick="trackEvent('click','MDT LP','Pop Up','More-Info')">More info</a>
  						</fieldset>
					</div>
					<div class="modal fade" id="myModal13" role="dialog">
					    <div class="modal-dialog modal-lg">
					     	...
					     	<div class="modal-content">
					        	<div class="modal-header text-center">
					         		<button type="button" class="close" data-dismiss="modal">×</button>
					          		<img src="images/David-Robertson.png" alt="David Robertson" title="David Robertson" class="img-circle">
					          		<!-- <h4 class="modal-title">Modal Header</h4> -->
					        	</div>
					       		<div class="modal-body">
					          		<p class="text-center profile">
									...
									<p>David Robertson is a Senior Lecturer at the MIT Sloan School of Management where he teaches Product Development and Digital Product Management. David is the author of the award-winning book about LEGO’s near-bankruptcy and spectular recovery: <i> Brick by Brick: How LEGO Rewrote the Rules of Innovation and Conquered the Global Toy Industry (Crown, 2013)</i>.
									</p>
					       		 </div>
					       		<!-- <div class="modal-footer">
					          		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		...
		<div class="margin-section clearfix">
			<div class="clearfix certificate">
				<h1 class="heading padl80 hide-destop">Certificate</h1>
					<div class="certificate-img col-md-7 col-sm-7 col-md-pull-5">
						<div class="padr80">
							<img src="images/certificate.jpg" alt="Mastering Design Thinking" title="Mastering Design Thinking"class="img-responsive">
						</div>	
					</div>
					<div class="certificate-text col-md-5 col-sm-5 col-md-push-7">
						<div class="padl80">
							<h1 class="heading no-marg">Certificate</h1>
							<p class="text-left padl80">Get a verified digital certificate of completion from MIT Sloan School of Management. This program also counts towards an MIT Sloan Executive Certificate. <a href="https://executive.mit.edu/executivecertificates#.WZwbPj4jHIW" target="_blank" onclick="trackEvent('click','MDT LP','Redirect','Learn More',true)">Learn More </a>
							</p>
		...
		<div class="top-footer">
			<div class="text-center">
				...
				<h5>Flexible payment options available. <a href="#" onclick="trackEvent('click','MDT LP','Redirect','Flexi Pay')" class="applynow" data-toggle="modal" data-target="#myModal">Click here</a> to know more.</h5>
			</div>
		</div>
          ...
          <div class="modal-body flexi">
            ...
            <h5>The following payment options are available for the <i>Mastering Design Thinking program</i>:</h5>
				...
				<ul class="ul_style">Pay in 2 installments</ul>
					...
					<li>The second installment of <b>$1,167</b> will be charged on <b>April 14, 2018</b>.
					</li>
				</ul>
				...
				<ul class="ul_style">Pay in 3 installments</ul>
					...
					<li>The second installment of <b>$874</b> will be charged on <b>April 14, 2018</b>.
					</li>
					<li>The third installment of <b>$874</b> will be charged on <b>May 9, 2018</b>.
					</li>
				</ul>
            </div>
    </div>
...
<script async type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.17.0/jquery.validate.min.js"></script>
		...
		<script async type="text/javascript" src="js/com.js?v=0.0.1"></script>
		...
		function onPlayerStateChange(event) { 
			...
			{
				trackEvent('Play', 'MDT LP', 'Watch Video', 'Play Video', false);
			} 
		} 
		</script> 
		<!-- Tracking Code Start--> 
