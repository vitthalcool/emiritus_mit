...
<head>
		...
		<link rel="stylesheet" type="text/css" href="assets/css/bootstrap.css">		<link rel="stylesheet" href="https://emeritus.org/programmes/common/gdpr.css">		
	...
	<div class="wrapper">
		<div class="container-fluid" id="header">
			<div class="container">
				<header class="header">
					<div class="row">
						  <div class="col-sm-6">
							<a href="./mastering-design-thinking-v2.php" onclick="trackEvent('click','MDT LP','Reload','Partner Logo')"><img src="https://eim.mit.edu/assets/images/logo.png" alt="MIT Sloan" title="MIT Sloan" class="img-responsive"></a>
						</div>						
					</div>
				</header>
			</div>	
		...
		<div class="container df vedio-section">
				...
				<div id="2" class="col-md-5 col-sm-6 col-xs-12 banner-item section-form">
						<form class="form-horizontal registerform" role="form" id="frm" name="frm" method="POST" action="submit.php" >
