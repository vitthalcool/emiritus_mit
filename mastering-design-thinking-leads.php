...
<head>
		...
		<link rel="stylesheet" type="text/css" href="assets/css/ootstrap-theme.min.css">				<link rel="stylesheet" href="https://emeritus.org/programmes/common/gdpr.css">		
		...
		<div class="container-fluid" id="header">
			<div class="container">
				<header class="header">
					<div class="row">
						  <div class="col-sm-6">
							<a href="./mastering-design-thinking-leads.php" onclick="trackEvent('click','MDT LP','Reload','Partner Logo')"><img src="https://eim.mit.edu/assets/images/logo.png" alt="MIT Sloan" title="MIT Sloan" class="img-responsive"></a>
						</div>						
					</div>
				</header>
			</div>	
				...
				<div class="container df">
					<div class="col-md-7 no_pad">
						...
						<div id="2" class="col-md-5 form-div no_pad form-section">
							<form class="form-horizontal contact-form" role="form" id="frm" name="frm" method="POST" action="submit-leads.php">
