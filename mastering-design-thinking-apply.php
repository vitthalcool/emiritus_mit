...
<head>
		...
		<link rel="stylesheet" type="text/css" href="assets/css/style_new.css?v=0.0.4">
		...
		<script  src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>		<script id="Cookiebot" src="https://consent.cookiebot.com/uc.js" data-cbid="e71576a1-0522-411a-b664-6e273d169185" type="text/javascript" async></script>
		...
		<div class="container-fluid" id="header">
			<div class="container">
				<header class="header">
					<div class="row">
						  <div class="col-sm-6">
							<a href="./masterting-design-thinking-apply.php" target="_blank" onclick="trackEvent('click','MDT LP','Reload','Partner Logo')"><img src="https://eim.mit.edu/assets/images/logo.png" alt="MIT Sloan" title="MIT Sloan" class="img-responsive"></a>
						</div>						
					</div>
				</header>
			</div>	
								...
								<form style="overflow:auto;" role="form" class="form-horizontal mCustomScrollbar">
										<div class="download_padding">
											<p class="thankyou">It's not too late to join 7200+ students from 120+ countries who have already taken our programs.</p>
												<p class="getintouch" style="margin-bottom:0px;">Application Deadline: June 27, 2018</p>
												<p class="getintouch" style="margin-bottom:0px;">Program Starts: June 28, 2018</p>
												<div class="text-center">
												<p style="padding:2% 0;"><a style="display: block; margin: 0 auto;width: 144px;text-decoration:none ! important;border-color:#b8434f;" class="btn btn-default download-btn-link" href="http://bit.ly/2oSng5n" onclick="trackEvent('click','MDT LP','Redirect','Apply Now')" target="_blank"> APPLY NOW</a></p>
