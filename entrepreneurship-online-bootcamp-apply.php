...
<head>
	...
	<link rel="stylesheet" type="text/css" href="https://eim.mit.edu/bootcamp-assets/css/responsive_v1.css?v=0.0.1">
...
<body>
	<div class="wrapper">
		<div class="container-fluid" id="header">
			<div class="container">
				<header class="header">
					<div class="row">
						  <div class="col-sm-6">
							<a href="https://eim.mit.edu/entrepreneurship-online-bootcamp.php" onclick="trackEvent('click','EOB LP','Reload','Partner Logo')"><img src="https://eim.mit.edu/bootcamp-assets/images/logo.png" alt="MIT's Entrepreneurship Bootcamp" title="MIT's Entrepreneurship Bootcamp" class="img-responsive"></a>
						</div>						
					</div>
				</header>
			</div>	
			...
			<div class="banner-bg">
				<div class="container df">
					...
					<div id="2" class="col-md-5 form-div no_pad form-section">
						<form style="overflow:auto;" role="form" class="form-horizontal mCustomScrollbar">
							<div class="download_padding">
								...
								<p class="getintouch" style="margin-bottom:0px;">Application Deadline: August 8, 2018</p>
								<p class="getintouch" style="margin-bottom:0px;">Program Starts: August 9, 2018</p>
								<div class="text-center">
									<p style="padding:2% 0 40px 0;margin: 0;"><a target="_blank" onclick="trackEvent('click','EOB LP','Redirect','Apply Now')" style="display: block; margin: 0 auto;width: 144px;text-decoration:none ! important;border-color:#b8434f;" class="btn btn-default download-btn-link" href="https://emeritus-admissions.secure.force.com/StudentPrograms?pid=01t0I0000042WWp">APPLY NOW</a>
									</p>								
								<!-- <p class="text-center intro-text">or</p>
								<a href="https://emeritus-admissions.secure.force.com/StudentPrograms?pid=01t0I0000067d36" onclick="trackEvent('click','EOB LP','Download PDF','Download Brochure')" class="btn btn-default download-btn-link" target="_blank">UPGRADE TO SOLO TRACK</a> -->
								</div>
								<!-- <div class="text-center" style="padding-top:20px;">
								<p class="thankyou"><a href="#" onclick="trackEvent('click','EOB LP','Pop Up','Solo Track')" class="applynow" data-toggle="modal" data-target="#myModalsolo"><i>Click here for details of Solo Track</i></a>. </p> 
								</div>	-->							
							</div>
						</form>
					</div>
					...
					<div class="col-md-4 col-sm-4">
						<fieldset class="featured_faculty">
    						<legend align="center" class="img-circle"><img src="https://eim.mit.edu/bootcamp-assets/images/William-Aulet.png" alt="William Aulet" title="William Aulet"></legend>
								...
								<a class="txt-color" data-toggle="modal" data-target="#myModal11" onclick="trackEvent('click','EOB LP','Pop Up','Faculty')">More info</a>
  						</fieldset>
					</div>
					<!-- Modal -->
					...
					<div class="col-md-4 col-sm-4">
						<fieldset class="featured_faculty">
    						<legend align="center" class="img-circle"><img src="https://eim.mit.edu/bootcamp-assets/images/Eric-von-Hippel.png" alt="Professor Eric von Hippel" title="Professor Eric von Hippel"></legend>
								...
								<a class="txt-color" data-toggle="modal" data-target="#myModal12" onclick="trackEvent('click','EOB LP','Pop Up','Faculty')">More info</a>
  						</fieldset>
					</div>
					...
					<div class="col-md-4 col-sm-4">
						<fieldset class="featured_faculty">
    						<legend align="center" class="img-circle"><img src="https://eim.mit.edu/bootcamp-assets/images/Erdin-Beshimov.png" alt="Erdin Beshimov" title="Erdin Beshimov"></legend>
								...
								<a class="txt-color" data-toggle="modal" data-target="#myModal13" onclick="trackEvent('click','EOB LP','Pop Up','Faculty')">More info</a>
  						</fieldset>
					</div>
			...
			<div class="container featured-alumini-speak">
				<h1 class="heading">Featured Alumni</h1>	
					...
					<div class="col-md-12 col-sm-12 col-xs-12 text-right loadm">
						<a href="" onclick="trackEvent('click','EOB LP','Expand','Load More Alumni')" class="load_more" id="loadMore">Load more</a>
					</div>
				</div>
				...
				<div class="container Alumni-speak" >
						...
						<div class="row p-50 container-row text-center">	
							<div class="carousel slide" data-ride="carousel" id="quote-carousel" tabindex="-1">
								...
								<a data-slide="prev" href="#quote-carousel" class="left carousel-control" onclick="trackEvent('click','EOB LP','Slide','Alumni Speak')"><i class="fa fa-chevron-left" ></i></a>
								<a data-slide="next" href="#quote-carousel" class="right carousel-control" onclick="trackEvent('click','EOB LP','Slide','Alumni Speak')"><i class="fa fa-chevron-right"></i></a>
							</div>
						</div>
				</div>
			</div>
				...
				<h1 class="heading padl80 hide-destop">Certificate</h1>
					...
					<div class="col-md-7 col-sm-7 certificate-text-section">
						<div class="padl80">
							...
							<a href="#2" onclick="trackEvent('click','EOB LP','ScrollUp','Earn Your Certificate')" target="_blank"><button class="btn btn-default download-btn">EARN YOUR CERTIFICATE</button></a>
						</div>
					</div>
			</div>
		</div>
		...
		<!-- <div class="modal fade" id="myModalsolo" role="dialog">
					    <div class="modal-dialog modal-lg track-section">
					     	<div class="modal-content">
					        	<div class="container online-bootcamp" id="bootcamp-track">
									<button type="button" class="modal-header close" data-dismiss="modal">×</button>
									<h1 class="heading">Online Bootcamp Tracks</h1>	
										<div class="row p-50 container-row">
										<div class="clearfix">
											<p class="text-center right-path">Which path is right for you?</p>
										</div>
										<div class="col-sm-12 hidden-xs path-image" id="track-section">
										...
										<div class="col-sm-12 visible-xs icon-row path-image" id="track-section1">
										...
										<div class="clearfix">
											<p class="text-left datatext padd-lf">With MIT’s online Bootcamp, there are many paths to success. You can either participate in the most popular group format, bringing your own team or joining a team of other entrepreneurs. New for June 2018 — you can choose the solo track for individuals who wish to protect their intellectual property and receive private coaching sessions from MIT-trained coaches.
											</p>
										</div>
										
										<p class="datatext"><b>Program Fees for Solo Track:</b> $4,300 (Flexible payment options available).</p>											
									</div>
